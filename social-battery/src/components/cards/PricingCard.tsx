...
const options = [
  {
    ...
    label: "One-off",
    priceKey: "oneOff" as const,
    desc: "Single outing purchase",
  },
  {
    key: "category_pass" as const,
    label: "Category Pass",
    priceKey: "categoryPass" as const,
    desc: "Member price · from $16/mo",
  },
  {
    key: "all_access" as const,
    label: "All Access Pass",
    priceKey: "allAccess" as const,
    desc: "Best price · $60/mo",
  },
];
  ...
  return (
    <div className="space-y-3">
        ...
        return (
          ...
          >
            <AppCard
              ...
              selected={isSelected}
              animate={false}
              className={cn(isSelected && "glow-accent")}
            >
              <div className="flex items-center justify-between">
                <div>
      ...
      {pricing.discounted !== undefined && (
        <AppCard variant="pricing" className="border border-emerald-500/25">
          <p className="text-sm">
